...
{
    //public:
    //data and methods are accessable to every one
    //private:
    //data and methods are accessable only in the class
    //protected:
    //data and methods are accessable only from class and it's drived class
