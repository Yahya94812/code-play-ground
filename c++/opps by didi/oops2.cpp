...
class Student{
    ...
    //parameterized
    Student(string name, int rollNo, int marks){//same as function definition
        this->name=name;
        this->rollNo=rollNo;
        this->marks=marks;
    }

    Student(Student* other){//custom copy constructor
...
int main(){
    ...
    //but the deep copy is the copy of not just the properties but the attributes that are pointing to other objects and values are also copied and it is used for the dynamic memory allocation as the new dynamic memory allocation is occured by the deep copy method 
